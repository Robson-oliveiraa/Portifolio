...
function AboutMe() {
    return (
        <div className=" flex flex-col w-auto">
            ...
            <p className="text-base font-normal pl-3 pt-2 md:text-xl dark:text-zinc-100">Ola, sou dev Front-end, hoje em dia uso Next.js com TypeScript e o Vite como meus framework fullStarks, tambem sei o basico de back-end com o TypeScript, estou sempre em buscar de novas tecnologias e sempre disposto a buscar novos conhecimentos.</p>
        </div>
    )
}
...
export default function Body() {
    return (
        <div className="px-6 md:mx-16 xl:grid xl:grid-cols-2 gap-12 my-14 flex flex-col py-[38px] ">
